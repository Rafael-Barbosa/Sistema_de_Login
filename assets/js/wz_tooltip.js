...
config. FontSize		= '25px'		// E.g. '9pt' or '12px' - unit is mandatory
...
config. Width			= 110		// Tooltip width; 0 for automatic adaption to tooltip content; < -1 (e.g. -240) for a maximum width for that automatic adaption;
